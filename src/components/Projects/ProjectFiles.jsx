const ProjectFiles = [
  ...
  {
    id: 2,
    path: '../assets/Images/ParkingApp.png',
    desc: 'Dock N Flock',
  ...
  {
    id: 3,
    path: '../assets/Images/Ecommerce.png',
    desc: 'Shop-Shop',
  ...
  {
    id: 6,
    path: '../assets/Images/BookSearch.png',
    desc: 'Best Sellers',
  ...
  {
    id: 7,
    path: '../assets/Images/ThoughtBlog.png',
    desc: 'Deep Thoughts',
  ...
  {
    id: 8,
    path: '../assets/Images/googlebooks.png',
    desc: 'Google Books',
