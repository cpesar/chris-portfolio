        ...
        <div className='overlay p-5 flex flex-col items-center font-mono text-center'>
          <section className='container flex flex-col items-center py-40'>
            ...
            <p class=' text-blue-300 rounded-lg shadow text-2xl '>
              ...
              driven and passionate web developer with an extensive background
              in B2C sales, and marketing. Chris recently advanced his education
              by attending the coding bootcamp at the University of Utah which
              compliments his business degree from Towson University, making him
              a well-rounded hire with a lot to offer. When Chris is not in
